...
exports.maximalMarginalRelevance = exports.cosineSimilarity = void 0;
...
function cosineSimilarity(X, Y) {
    ...
    return X.map((xVector) => Y.map((yVector) => ml_distance_1.similarity.cosine(xVector, yVector)).map((similarity) => (Number.isNaN(similarity) ? 0 : similarity)));
}
